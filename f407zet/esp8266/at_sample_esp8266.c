...
#define ESP8266_SAMPLE_DEIVCE_NAME     "uart3"
#define ESP8266_SAMPLE_CLIENT_NAME     "client0"
#define ESP8266_SAMPLE_WIFI_SSID        "hello"
#define ESP8266_SAMPLE_WIFI_PASSWORD     "12345678"
#define ESP8266_SAMPLE_RECV_BUFF_LEN     8
